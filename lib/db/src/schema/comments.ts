...
export const commentsTable = pgTable("comments", {
  ...
  // Creator-moderator can "feature" one argument per side — surfaced at the top.
  isFeatured: boolean("is_featured").notNull().default(false),
  // Creator-moderator can lock replies on a specific argument (no new replies allowed).
  repliesLocked: boolean("replies_locked").notNull().default(false),
