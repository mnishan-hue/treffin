  ...
  return (
    <AuthShell title="Welcome back" subtitle="Sign in to your Treffin account">
      <form onSubmit={submit} className="mt-6 flex flex-col gap-4">
        ...
        <button disabled={pending} className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 py-2.5 font-semibold text-white disabled:opacity-60">{pending ? "Signing in…" : "Sign in"}</button>
