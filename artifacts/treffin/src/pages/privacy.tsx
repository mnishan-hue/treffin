...
const SECTIONS: { title: string; body: string }[] = [
  ...
  {
    title: "Third parties",
    body: "We use Better Auth for authentication and a managed PostgreSQL provider for storage. These providers process data on our behalf under their own security standards.",
  },
  {
    title: "Cookies",
