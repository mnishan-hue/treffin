    ...
    <AppLayout rightSidebar={
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 pb-1">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground leading-tight flex items-center gap-1.5">Discover <SectionInfo title="Discover" icon="🧭" accent="from-indigo-500 to-violet-600" description="All of Treffin in one feed: debates, articles, posts, and math problems. Use search or filters to zero in on exactly what interests you." /></h1>
          </div>
          {!isLoading && (
