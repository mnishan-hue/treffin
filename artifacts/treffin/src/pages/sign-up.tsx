        ...
        <div className="rounded-2xl border border-[#1e2d45] bg-[#0d1117] p-6 shadow-2xl shadow-black/50">
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            <form onSubmit={submit} className="flex flex-col gap-4">
              ...
              <button disabled={pending || googlePending} className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 py-2.5 font-semibold text-white disabled:opacity-60">{pending ? "Creating account…" : "Create account"}</button>
            </form>
