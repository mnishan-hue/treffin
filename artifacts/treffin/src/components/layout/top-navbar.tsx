        ...
        <Link href="/">
          <div className="flex items-center gap-2.5 cursor-pointer shrink-0 group">
            <img
              ...
              alt="Treffin"
              className="h-8 w-auto object-contain drop-shadow-[0_0_10px_rgba(99,102,241,0.6)] group-hover:drop-shadow-[0_0_16px_rgba(99,102,241,0.85)] transition-all"
            />
          ...
          {isSignedIn && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48 bg-card border-border">
                ...
                <DropdownMenuItem onClick={async () => { await authClient.signOut(); setLocation("/"); }} className="cursor-pointer text-destructive focus:text-destructive">
