...
import { battleAcceptsInteraction, debateAcceptsParticipation, destructiveDbToolsEnabled, isDebateSide, isDebateWinnerSide, resolveTrustedFrontendUrl } from "../security-policy";
